...
const Checkout = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    termsAccepted: false,
    tickets: [], // Store selected tickets
    totalAmount: 0, // Store calculated total price
  });
  ...
  const initiateRazorpayPayment = async () => {
    try {
      ...
      const options = {
        key: "rzp_test_rHz3thjMZYaAVo", // Replace with your Razorpay key ID
  ...
  const handleNext = () => {
    if (!isLoggedIn && currentStep === "ticket") {
              ...
              <div className="animate-fade-in">
                ...
                {!isLoggedIn ? (
                  <div className="p-4 bg-white/5 rounded-lg mb-6 text-center">
                    <AlertCircle
                      className="text-bollywood-red mx-auto mb-2"
                      size={24}
                    />
                    ...
                    <button
                      ...
                      className="bg-bollywood-red text-white px-4 py-2 rounded-lg hover:bg-bollywood-red/90 transition-colors"
                    >
                      Sign In
                    </button>
                  </div>
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <select
                                    ...
                                    className="w-full bg-[#1E1E1E] text-white border border-gray-500 rounded-lg px-4 py-2 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  >
                                    <option value="STAG">
                                      STAG Entry (₹250)
                                    </option>
                              ...
                              <div>
                                ...
                                <div className="flex items-center border border-white/30 rounded-lg w-100">
            ...
            {currentStep === "confirm" && bookingDetails && (
              <div className="animate-fade-in text-center">
                ...
                <p className="text-white/70 mb-8">
                  ...
                  successfully. We've sent a confirmation email to{" "}
                  {formData.email}.
                </p>
                ...
                <div className="glass-panel p-6 mb-8 mx-auto max-w-md">
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">
                        {(bookingDetails as any).bookingId ||
                          `BN${Math.floor(Math.random() * 10000)}`}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  disabled={
                    loading ||
                    (currentStep === "ticket" &&
                      (!isLoggedIn || selectedTickets.length === 0))
                  }

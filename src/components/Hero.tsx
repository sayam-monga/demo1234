      ...
      <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-white/80 max-w-xl mx-auto mb-8 text-shadow-sm">
            Experience the ultimate Bollywood night with music, dance, and
            glamour. A night filled with your favorite Bollywood hits and
            performances.
          </p>
        </div>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-white font-medium">March 13, 2023</p>
            </div>
          </div>
          <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-white font-medium">5:30 PM Onwards</p>
            </div>
          </div>
        </div>
